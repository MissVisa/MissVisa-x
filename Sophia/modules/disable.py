...
from MissVisa.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from MissVisa.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from MissVisa.modules.sql import disable_sql as sql
    ...
    def enable_module(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            enable_module = "MissVisa.modules." + args[0].rsplit(".", 1)[0]
